        ...
        <form className={`d-flex mr-auto ml-auto flex-wrap ${styles.formLogin}`} onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='d-flex flex-direction-column mb-4'>
                ...
                <div className='d-flex'>
                    ...
                    <input className="form-control me-2 border-0" type="email" placeholder='xyz@akgec.ac.in' name="email" {...register("email", { required: "email is required", pattern: { value: /^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$/i, message: "this is not a valid email" } })} />
